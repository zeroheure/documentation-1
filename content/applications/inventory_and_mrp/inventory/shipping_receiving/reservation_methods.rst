...
.. tabs::
   ...
   .. tab:: Before scheduled date
      ...
      A specific number of days can be selected; this will be the maximum number of days **before**
      a scheduled delivery date that products should be reserved.
...
.. note::
   ...
   *resupply subcontractor* orders, *repairs* orders, and *internal transfers*. To enable this,
   ...
   - **For repairs:** Install the *Repairs* application by going to :menuselection:`Apps`, locating the
     *Repairs* app, and clicking :guilabel:`Install`.
...
Operations Types`, then clicking on a specific operations type.
